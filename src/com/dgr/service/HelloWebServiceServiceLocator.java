/**
 * HelloWebServiceServiceLocator.java
 *
...
public class HelloWebServiceServiceLocator extends org.apache.axis.client.Service implements com.dgr.service.HelloWebServiceService {

    public HelloWebServiceServiceLocator() {
    }


    public HelloWebServiceServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public HelloWebServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HelloWebServicePort
    private java.lang.String HelloWebServicePort_address = "http://localhost:8080/WevService2";
    ...
    public com.dgr.service.HelloWebService getHelloWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.dgr.service.HelloWebServicePortBindingStub _stub = new com.dgr.service.HelloWebServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.dgr.service.HelloWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.dgr.service.HelloWebServicePortBindingStub _stub = new com.dgr.service.HelloWebServicePortBindingStub(new java.net.URL(HelloWebServicePort_address), this);
                _stub.setPortName(getHelloWebServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.dgr.com/", "HelloWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.dgr.com/", "HelloWebServicePort"));
        }
